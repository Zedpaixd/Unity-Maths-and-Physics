...
public class PinballSphereObstacle : MonoBehaviour, IPinballObstacle
{
    ...
    public void AddScore()
    {
        ...
        GameObject scoreOb = Instantiate(scoreDisplayObject, transform.position + Vector3.up * (transform.localScale.y + 1), Quaternion.identity);
